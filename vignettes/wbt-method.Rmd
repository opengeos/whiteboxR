...
The SpatVectorProxy provides a light-weight means to create an R object reference to a large file; allowing the "heavy" lifting for that file to be done primarily by WhiteboxTools.
...
# create a GeoPackage
writeVector(x2, filename = file.path(tempdir(), "lux.gpkg"), overwrite = TRUE)
