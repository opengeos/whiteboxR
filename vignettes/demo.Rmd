...
The executable path and other options are stored as package options, and can be over-ridden by system environment variables. A default value `wbt_exe_path(shell_quote = FALSE)` is passed when the `exe_path` argument is left unspecified.
